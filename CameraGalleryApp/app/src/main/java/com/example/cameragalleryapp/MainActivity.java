...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGallery.setOnClickListener(v -> {
            String savedUri = getSharedPreferences("FolderPrefs", MODE_PRIVATE).getString("folderUri", null);
            if (savedUri == null) {
                Intent intent = new Intent(Intent.ACTION_OPEN_DOCUMENT_TREE);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 200 && resultCode == RESULT_OK && data != null) {
            ...
            getSharedPreferences("FolderPrefs", MODE_PRIVATE).edit()
                    .putString("folderUri", selectedFolderUri.toString()).apply();
        ...
        if (requestCode == 101 && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                if (pickedDir != null && pickedDir.canWrite()) {
                    DocumentFile newFile = pickedDir.createFile("image/jpeg", "photo_" + System.currentTimeMillis());
